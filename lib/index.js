...
'handlebars');var _handlebars2 = _interopRequireDefault(_handlebars);var _swag = require(
'swag');var _swag2 = _interopRequireDefault(_swag);var _handlebarsHelpers = require(
'handlebars-helpers');var _handlebarsHelpers2 = _interopRequireDefault(_handlebarsHelpers);var _minimist = require(
...
'mkdirp-then');var _mkdirpThen2 = _interopRequireDefault(_mkdirpThen);
...
files) {var outputDirectory = arguments.length <= 1 || arguments[1] === undefined ? process.cwd() : arguments[1];var 
  outputExtension = arguments.length <= 2 || arguments[2] === undefined ? 'html' : arguments[2];var data = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];var stdout = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];return _regeneratorRuntime.async(function renderHandlebarsTemplate$(context$1$0) {while (1) switch (context$1$0.prev = context$1$0.next) {case 0:context$1$0.next = 2;return _regeneratorRuntime.awrap(
        _Promise.all(files.map(function renderTemplate(file) {var 
          ...
          htmlContents;return _regeneratorRuntime.async(function renderTemplate$(context$2$0) {while (1) switch (context$2$0.prev = context$2$0.next) {case 0:debug('Rendering template ' + file + ' with data', data);path = _path.resolve(outputDirectory, _path.basename(file, _path.extname(file)) + '.' + outputExtension);_swag2['default'].registerHelpers(_handlebars2['default']);_handlebars2['default'].registerHelper(_handlebarsHelpers2['default']());context$2$0.t0 = _handlebars2['default'];context$2$0.next = 7;return _regeneratorRuntime.awrap(_fsPromise.readFile(file, 'utf8'));case 7:context$2$0.t1 = context$2$0.sent;context$2$0.t2 = data;htmlContents = context$2$0.t0.compile.call(context$2$0.t0, context$2$0.t1)(context$2$0.t2);if (!
                stdout) {context$2$0.next = 15;break;}context$2$0.next = 13;return _regeneratorRuntime.awrap(
                process.stdout.write(htmlContents, 'utf8'));case 13:context$2$0.next = 21;break;case 15:context$2$0.next = 17;return _regeneratorRuntime.awrap(

                _mkdirpThen2['default'](outputDirectory));case 17:context$2$0.next = 19;return _regeneratorRuntime.awrap(
                _fsPromise.writeFile(path, htmlContents, 'utf8'));case 19:
                debug('Wrote ' + path);
                console.error('Wrote ' + path + ' from ' + file);case 21:case 'end':return context$2$0.stop();}}, null, this);})));case 2:case 'end':return context$1$0.stop();}}, null, this);}
